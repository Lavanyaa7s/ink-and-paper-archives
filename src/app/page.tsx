...
const highlightPlates: ArchivalPlate[] = [
  {
    ...
    specs: "35MM · f/1.4 · 1/2000s · ISO 100",
  },
  {
    ...
    specs: "85MM · f/1.8 · 1/500s · ISO 200",
  },
  {
    id: "wedding-plate-01",
    ...
    specs: "50MM · f/1.2 · 1/1000s · ISO 160",
  },
  {
    ...
    specs: "24MM · f/8.0 · 1/125s · ISO 100",
  },
];
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FAFAF7] text-[#111111] selection:bg-[#111111] selection:text-[#FAFAF7]">
      
      {/* =========================================================================
          ARCHIVAL REGISTRATION BAR (Sticky / Floating Luxury Top Header)
          ========================================================================= */}
      <header className="sticky top-0 z-40 w-full bg-[#FAFAF7]/90 backdrop-blur-md border-b border-[#111111]/15 px-6 py-5 md:px-16 transition-colors">
      ...
      {/* =========================================================================
          ...
          Zero AI gimmicks, zero splash screens, zero scroll hijacking!
          ========================================================================= */}
      <section className="min-h-[88vh] flex flex-col justify-between pt-12 pb-20 px-6 md:px-16 max-w-7xl mx-auto border-b border-[#111111]/15 select-none relative overflow-visible">
        ...
        <div className="flex justify-between items-start text-xs font-bold uppercase tracking-[0.26em] text-[#666666]">
          <span>BOOK 01 — CURATED ARCHIVES</span>
        ...
        <div className="my-10 md:my-16 flex items-center justify-center relative w-full">
          ...
          {/* Center Cutout Silhouette: Maindhaa (No background box, no border box!) */}
          <motion.div
            initial={{ opacity: 0, scale: 0.96, y: 15 }}
            animate={{ opacity: 1, scale: 1, y: 0 }}
            transition={{ duration: 0.9, ease: [0.22, 1, 0.36, 1] }}
            whileHover={{ scale: 1.02 }}
            className="z-20 relative flex-shrink-0 w-[64vw] max-w-[280px] sm:max-w-[360px] md:max-w-[420px] aspect-[3/4] -mx-8 sm:-mx-16 md:-mx-24 drop-shadow-[0_35px_50px_rgba(0,0,0,0.28)] pointer-events-auto"
          >
            <Image
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-[#FAFAF7]/95 px-4 py-3 border border-[#111111]/10 text-center">
                  ...
                  <div className="text-[9px] uppercase tracking-[0.18em] text-[#666666] mt-0.5">
                    CLICK GALLERY TO VIEW MASTER PLATES →
                  </div>
                </div>
              </motion.div>
            ) : (
      ...
      <section className="py-24 md:py-36 px-6 md:px-16 max-w-7xl mx-auto border-b border-[#111111]/15">
        <div className="flex flex-col md:flex-row justify-between items-baseline mb-16">
          ...
          <p className="mt-6 md:mt-0 max-w-md text-sm text-[#666666] leading-relaxed font-normal">
            A curated selection of signature plates across automotive, portraiture, weddings, and commercial architecture. Click any plate to inspect full resolution and exposure data.
          </p>
        </div>
              ...
              >
                <div className={`relative ${aspectClass} w-full overflow-hidden border border-[#111111]/15 bg-[#EFEFEA] shadow-lg group-hover:shadow-2xl transition-shadow`}>
                  ...
                  <div className="absolute inset-0 bg-[#111111]/0 group-hover:bg-[#111111]/15 transition-colors flex items-center justify-center">
                    <span className="opacity-0 group-hover:opacity-100 bg-[#FAFAF7] text-[#111111] px-4 py-2 text-[10px] font-bold uppercase tracking-[0.24em] transition-opacity duration-300 shadow-md">
                      INSPECT PLATE +
                    </span>
                  </div>
                </div>
                ...
                <div className="text-[10px] font-medium uppercase tracking-[0.2em] text-[#666666] mt-1">
                  {plate.discipline} · {plate.location}
                </div>
              </div>
            );
          })}
      ...
      <AnimatePresence>
        {selectedPlate && (
          <motion.div
            ...
            className="fixed inset-0 z-50 bg-[#111111]/90 backdrop-blur-md flex items-center justify-center p-4 sm:p-8 md:p-16 cursor-zoom-out"
          >
            <div
            ...
            >
              ...
              <div className="p-6 bg-[#FAFAF7] grid grid-cols-1 sm:grid-cols-3 gap-6 border-t border-[#111111]/15 text-xs font-bold uppercase tracking-[0.24em]">
                ...
                <div>
                  <div className="text-[#666666] text-[10px]">EXPOSURE SPECS</div>
