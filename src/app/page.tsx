      ...
      <main>
        ...
        <section className="relative w-full h-screen min-h-[600px] bg-[#92000A] text-[#FAFCBE] overflow-hidden flex flex-col justify-between pt-8 md:pt-12">
          ...
          <div className="absolute top-[40%] md:top-[35%] lg:top-[30%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center z-10 pointer-events-none px-2">
            <div className="relative inline-block">
              <motion.h1 
                ...
                className="font-[family-name:var(--font-yeseva)] uppercase text-[22vw] md:text-[11vw] lg:text-[10vw] leading-[0.85] md:leading-none tracking-tight whitespace-normal md:whitespace-nowrap flex flex-col md:inline relative z-10"
              >
              ...
              <motion.div 
                ...
                className="absolute -bottom-[5%] md:-bottom-[15%] lg:-bottom-[20%] right-[-5%] md:right-[2%] lg:right-[5%] text-5xl md:text-3xl lg:text-5xl font-[family-name:var(--font-shrikhand)] tracking-wide relative z-10"
              >
                Maindha
              </motion.div>
            </div>
          ...
          <motion.div 
            ...
            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full sm:w-[80%] md:w-[60%] lg:w-[45%] max-w-[650px] h-[75%] md:h-[80%] lg:h-[85%] z-50 pointer-events-none"
          >
            <Image 
              src="/portfolio/photographer/portraitMaindha.png" 
              alt="Maindha Portrait" 
              fill 
              className="object-contain object-bottom drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative z-50"
              priority
            />
          </motion.div>
        </section>
